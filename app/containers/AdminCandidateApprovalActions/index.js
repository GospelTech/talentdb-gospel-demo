...
export function AdminCandidateApprovalActions({
  withApprove,
  withRevoke,
  ...
  // useInjectReducer({ key: 'candidateActions', reducer });
...
AdminCandidateApprovalActions.propTypes = {
...
export default compose(withConnect)(AdminCandidateApprovalActions);
